...
class DownloadRepairPhoneDataPage extends StatefulWidget {
  const DownloadRepairPhoneDataPage({super.key});

  @override
  State<DownloadRepairPhoneDataPage> createState() => _DownloadRepairPhoneDataPageState();
}

class _DownloadRepairPhoneDataPageState extends State<DownloadRepairPhoneDataPage> {
  DateTime? _startDate;
  DateTime? _endDate;
